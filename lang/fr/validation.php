...
return [
    ...
    | utilisés par la classe validator. Certaines règles ont plusieurs versions
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ici vous pouvez spécifier des messages personnalisés pour les attributs
    | en utilisant la convention "attribute.rule". Cela permet de créer rapidement
    | des messages personnalisés pour une règle donnée.
    |
    */
    ...
    | par des termes plus compréhensibles pour l’utilisateur comme "Adresse e-mail"
    | au lieu de "email". Cela rend le message plus clair.
    |
    */
