...
<div class="showModal fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden bg-brown/50 p-6"
     x-trap="modalOpen"
     @keydown.window.escape="$dispatch('close-modal'); modalOpen = false">
    <div class="flex flex-col gap-4 w-full max-w-screen max-h-screen h-full bg-beige-medium rounded-sm p-6">
